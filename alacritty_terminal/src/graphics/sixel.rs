            ...
            SixelCommand::ColorIntroducer => {
                ...
                if self.params_position >= 4 {
                    ...
                    let (r, g, b) = match self.params[1] {
                        // HLS.
                        1 => hls_to_rgb(p!(2, 360), p!(3, 100), p!(4, 100)),

                        // RGB.
                        2 => (p!(2, 100), p!(3, 100), p!(4, 100)),
...
///
/// Inputs:
///   h is in the range of `0..=360`.
///   l is in the range of `0..=100`.
///   s is in the range of `0..=100`.
///
/// Output values are in the range of `0..=100`.
